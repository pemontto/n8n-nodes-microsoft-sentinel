/**
 * Microsoft Sentinel V1/V2 Node Implementation
 *
 * Handles node versions 1 and 2:
 * - V1: Create or Update (upsert) operation, comment operations under Incident resource
 * - V2: Split Create/Update operations, Add/Remove Label operations, comment operations under Incident resource
 *
 * Uses @version displayOptions to differentiate v1 vs v2 behavior within this class.
 */
...
export class MicrosoftSentinelV1V2 implements INodeType {
